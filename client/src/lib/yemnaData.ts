...
export type Post = { id: number; author: Person; group?: string; time: string; text: string; image?: string; reactions: number; comments: number; shares: number; saved?: boolean; media?: number };
