...
export function AppShell({ children, title }: { children: ReactNode; title?: string }) {
  ...
  const isRelationAccountPage = ["/friends", "/friend-requests", "/friend-requests/sent", "/followers", "/following", "/people/discover", "/blocked", "/friend-suggestions", "/people/suggestions"].includes(location);
