...
| الإدارة — دون جلسة | `/admin/users` | قيد إعادة الالتقاط | أعيدت الحراسة الموحدة بعد اكتشاف عرض توضيحي سابق؛ لن تُعتمد نتيجة هاتفية قبل لقطة جديدة. |
| الإدارة — دون جلسة | `/admin/reports` | قيد إعادة الالتقاط | أعيدت الحراسة الموحدة بعد اكتشاف عرض توضيحي سابق؛ لن تُعتمد نتيجة هاتفية قبل لقطة جديدة. |
