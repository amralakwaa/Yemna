...
| الإدارة — دون جلسة | `/admin/users` | مرّ | عند عرض الهاتف `375×812` تظهر رسالة طلب تسجيل دخول بحساب مدير كاملة ضمن الإطار بعد تثبيت التخطيط. |
| الإدارة — دون جلسة | `/admin/reports` | مرّ | عند عرض الهاتف `375×812` تظهر رسالة طلب تسجيل دخول، مع توضيح أن البلاغات وتذاكر الدعم تتطلب صلاحية مدير، دون تجاوز أفقي. |
