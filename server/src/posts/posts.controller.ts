...
export class PostsController {
  ...
  @Get(":id/comments") comments(@Param("id") id: string, @Query() query: ListCommentsDto) { return this.posts.listComments(id, query); }
  @Get(":id/comments/engagement") @UseGuards(JwtAuthGuard) commentEngagement(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.posts.getCommentViewerReactions(req.user.sub, id); }
  @Get(":id/comments/hidden") @UseGuards(JwtAuthGuard) hiddenComments(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.posts.getHiddenCommentIds(req.user.sub, id); }
  ...
  @Post(":id/comments/:commentId/reactions") @UseGuards(JwtAuthGuard) reactToComment(@Req() req: AuthenticatedRequest, @Param("id") id: string, @Param("commentId") commentId: string, @Body() dto: ReactToPostDto) { return this.posts.reactToComment(req.user.sub, id, commentId, dto); }
  @Get(":id/comments/:commentId/reactions") commentReactions(@Param("id") id: string, @Param("commentId") commentId: string) { return this.posts.listCommentReactions(id, commentId); }
  @Post(":id/comments/:commentId/hide") @UseGuards(JwtAuthGuard) hideComment(@Req() req: AuthenticatedRequest, @Param("id") id: string, @Param("commentId") commentId: string) { return this.posts.hideComment(req.user.sub, id, commentId); }
  @Delete(":id/comments/:commentId/hide") @UseGuards(JwtAuthGuard) unhideComment(@Req() req: AuthenticatedRequest, @Param("id") id: string, @Param("commentId") commentId: string) { return this.posts.unhideComment(req.user.sub, id, commentId); }
